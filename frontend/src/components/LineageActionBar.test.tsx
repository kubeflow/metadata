...
describe('LineageActionBar', () => {
  ...
  const mountActionBar = (): ReactWrapper<LineageActionBarProps, LineageActionBarState, LineageActionBar> => (
    mount(<LineageActionBar initialTarget={testModel} setLineageViewTarget={setLineageViewTarget} />)
  );
